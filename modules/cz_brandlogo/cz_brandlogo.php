...
class Cz_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'cz_brandlogo';
        ...
        $this->templateFile = 'module:cz_brandlogo/views/templates/hook/cz_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('CZ_BRAND_SLIDER', 1);
        Configuration::updateValue('CZ_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('CZ_BRAND_SLIDER')
            && Configuration::deleteByName('CZ_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitCzBlockBrandLogos')) {
			...
			Configuration::updateValue('CZ_BRAND_NAME', (int)(Tools::getValue('CZ_BRAND_NAME')));
			$this->_clearCache('*');
    ...
    public function renderForm()
    {
        ...
        $helper->submit_action = 'submitCzBlockBrandLogos';
    ...
    {
        return array(
            'CZ_BRAND_SLIDER' => (int)Tools::getValue('CZ_BRAND_SLIDER', Configuration::get('CZ_BRAND_SLIDER')),
            'CZ_BRAND_NAME' => (int)Tools::getValue('CZ_BRAND_NAME', Configuration::get('CZ_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
            ...
            'slider' => Configuration::get('CZ_BRAND_SLIDER'),
			'brandname' => Configuration::get('CZ_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('cz_brandlogo');
